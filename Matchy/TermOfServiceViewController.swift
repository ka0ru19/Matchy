...
class TermOfServiceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerText = "利用規約"
        let chapterTextArray = ["第1条（適用）","第2条（利用登録）","第3条（ユーザーIDおよびパスワードの管理）","第4条（利用料金および支払方法）","第5条（禁止事項）","第6条（本サービスの提供の停止等）","第7条（著作権）","第8条（利用制限および登録抹消）","第9条（保証の否認および免責事項）","第10条（サービス内容の変更等）","第11条（利用規約の変更）","第12条（通知または連絡）","第13条（権利義務の譲渡の禁止）","第14条（準拠法・裁判管轄）"]
